...
const optuna_loading_message: CSS.Properties = {
    color: 'gray',
    fontWeight: 700,
    fontSize: '32px',
}

const optuna_loading_wrapper: CSS.Properties = {
    height: '100vh',
    display: 'flex',
...
export const Loading: FC = () => {
    return (
        <>
            <span style={optuna_loading_wrapper}>
                <svg className="optuna-animation" xmlns="http://www.w3.org/2000/svg" width="294.7" height="280" viewBox="0 0 221 210">
                ...
                <p style={optuna_loading_message} > NOW LOADING</p>
            </span>
        </>
    )
}